...
<body>
    ...
    <div class="header">
        <div class="container">
            <div class="navbar">
                <div class="logo">
                    <a href="index.php"><img src="images/maiclogo.jpg" alt="Logo" style="border-radius: 50%;"></a>
                </div>
                <div class="title student-title">
                    <a href="index.php">
                        <h3 style="font-size: 15px;">CLMS-MAIC Library System</h3>
                    </a>
                </div>
                <div class="student-navbar">
                    ...
                    ?>
                        ...
                        <li>
                            <p style="color: #ff1509; font-size:20px; font-weight: bold;padding-right:10px;" id='demo'>
                            </p>
                        </li>
    ...
    <div class="header">
        <div class="container">
            <div class="navbar">
                ...
                <div class="title">
                    <a href="index.php">
                        <h3>CLMS-MAIC Library System</h3>
                    </a>
                </div>
                <nav>
                    <ul id="menuitems">
