...
<body>
        ...
        <div class="form">
            <div class="form-container edit-form-container">
                ...
                <form action="" id="loginform" method="post" enctype="multipart/form-data">
                    ...
                    <div class="label">
                        <label for="student_username">Last Name : </label>
                    </div>
                    ...
                    <input type="text"  name="Acad" value="<?php echo $Acad; ?>">
    ...
    <?php
		if(isset($_POST['change']))
		{
			...
			$q1="UPDATE student SET student_username='$student_username',FullName='$FullName',Sem='$Sem',Acad='$Acad',Email='$Email'
