...
<body>
    <div class="edit-profile-container">
        <?php
			...
			$q= "SELECT student.studentid,FullName,ID,studentpic,issueinfo.bookid,books.bookname,ISBN,bookpic,issuedate,returndate,approve,authors.authorname,category.categoryname From issueinfo inner join student on issueinfo.studentid=student.studentid inner join books on issueinfo.bookid=books.bookid join authors on authors.authorid=books.authorid join category on category.categoryid=books.categoryid where student.studentid=$studentid and approve='' and issueinfo.bookid=$bookid";
